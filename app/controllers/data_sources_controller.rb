class DataSourcesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @data_source.update(data_source_params)
        format.html { redirect_to @data_source, notice: "Data source was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to data_sources_path, notice: "Data source was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def data_source_params
      params.expect(data_source: [ :creator_id, :name, :source_type, :config, :is_public ])
    end
end
