class UserGroupsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @user_group.update(user_group_params)
        format.html { redirect_to @user_group, notice: "User group was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_groups_path, notice: "User group was successfully destroyed.", status: :see_other }
