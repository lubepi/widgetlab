...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference("Widget.count") do
      post widgets_url, params: { widget: { color: @widget.color, description: @widget.description, is_public: @widget.is_public, name: @widget.name, type: @widget.type } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { color: @widget.color, description: @widget.description, is_public: @widget.is_public, name: @widget.name, type: @widget.type } }
